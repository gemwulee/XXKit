...
@property (strong, nonatomic)  OSMOImageLabelButton *singleButton;      //单拍
//@property (strong, nonatomic)  OSMOImageLabelButton *multipleButton;    //连拍
...
//    _multipleButton.frame   = CGRectMake(0, _singleButton.bottom, self.width, OSMOCapturePhotoModeView_HEIGHT);
    _panoButton.frame       = CGRectMake(0, _singleButton.bottom, self.width, OSMOCapturePhotoModeView_HEIGHT);
...
//    _multipleButton.frame   = CGRectMake(_singleButton.right,   0, OSMOCapturePhotoModeView_WIDTH, self.height);
    _panoButton.frame       = CGRectMake(_singleButton.right,  0, OSMOCapturePhotoModeView_WIDTH, self.height);
